...
namespace QLNS.BL
{
    public class DisciplineDL : BaseDL<Discipline>, IDisciplineDL
    {
        ...
        public PagingData<Discipline> FilterDiscipline(string? keyword, int? pageSize, int? pageNumber = 1)
        {
            ...
            string storedProcedureName = "Proc_Discipline_GetPaging";
            var parameters = new DynamicParameters();
            parameters.Add("v_Sort", "DisciplineDate ASC");
            ...
            using (var sqlConnection = new MySqlConnection(connectionDB))
            {
                ...
                {
                    var Discipline = multipleResults.Read<Discipline>().ToList();
                    ...
                    return new PagingData<Discipline>()
                    {
                        Data = Discipline,
