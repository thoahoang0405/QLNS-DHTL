          ...
          <form action="">
            <div class="column">
              <div class="input__box">
                ...
                <input :class="errors.tenhopdong != '' ? 'border-red' : ''" @blur="validateName" type="text"
...
export default {
  ...
  methods: {
    ...
    btnAddPosition() {
      ...
      try {
        axios
          .post("https://localhost:44301/api/kiluat", this.suaChucVu)
          .then(function (res) {
            console.log(res);
    ...
    btnEditPosition(data) {
      ...
      axios
        ...
        .then(function (res) {
          ...
          me.isOpenPopupFormEditPosition = false;
          me.getDataInfoBonus(obj.IDNhanVien);
        })
        .catch(function (err) {
